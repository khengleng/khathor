...
from typing import TYPE_CHECKING, Any, Deque, Generator, Optional, Set
...
class SyncMempoolManager:
    ...
    def _run(self) -> Generator[None, Any, None]:
        ...
        while self.missing_tips:
            ...
            tx = yield self.sync_manager.get_tx(tx_id)
    ...
    @inlineCallbacks
    def _dfs(self, stack: Deque[BaseTransaction]) -> Generator[None, BaseTransaction, None]:
        """DFS method."""
        while stack:
            tx = stack[-1]
